...
from resource_adapters.providers.openstack.vmoperations import *
from resource_adapters.providers.openstack.diskoperations import *
from resource_adapters.providers.openstack.commonoperations import *
from resource_adapters.providers.openstack.networkoperations import *
...
class Operations:
    def __init__(self, session, task_id, config, env_vars):
        ...
        LOG.debug("Openstack Operation init method", {'task_id': self.task_id})
    ...
    def __call__(self, operation_name, parameters: dict):
        LOG.debug("Openstack Operation call:%s" % parameters, {'task_id': self.task_id})
        try:
            self.add_audit_log("Openstack Operation", operation_name,
