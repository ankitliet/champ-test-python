...
class Engine:
    ...
    def __init__(self, **kwargs):
        ...
        LOG.debug("APIRequests Operation init:%s" % kwargs)
    ...
    def __call__(self, state: str, payload: Dict[str, str], autoinitiate: bool):
        ...
        try:
            ...
            self._logger.debug('Executing APIRequests operation:%s' % payload,
                               {'task_id': task_id})
            ...
            if not payload['parameters'].get('test_run', False):
                ...
                payload['parameters'] = operation_obj(state, parameters)
